...
<div id="ventaContainer">
    ...
    <div id="otrosVenta">
        ...
        <table id="others-table" class="tableCatsAnsResume">
            ...
            <tfoot>
                <tr>
                    <td colspan="3" style="justify-content: start;">
                        <button class="--secondary-action-btn gBtn" style="width: 200px!important;margin-left: 10px;" id="addNewOthersRow">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                <g clip-path="url(#clip0_2234_27105)">
