<div id="bussinessConfiguration" class="sideMenu-m">
    <button id="closebussinessConfiguration" class="sideMenuCloseButton" onclick="closebussinessConfiguration()">
    ...
    <div class="formHeader" style="align-items: center;align-content:center;margin-left: 14px;">
        ...
        <p class="header-P">Aquí puedes editar los datos de tu organización</p>
    </div>
    <form id="bussinessConfiguration" style="margin: 15px; height: 100%;">

        <div class="centered-spaced">

            <img id="bussinessLogo" src="../../ws/BussinessDocuments/bussLogo/b<?php echo $_SESSION["empresa_id"];?>l<?php echo $_SESSION['buss_data']->bl;?>" alt="Logo empresa" width="150" height="150"  />
            <!-- <img id="bussinessLogo" src="../../ws/BussinessDocuments/bussLogo/b<?php echo $_SESSION["empresa_id"];?>lcarFront.jpg" alt="Logo empresa" width="150" height="150"  /> -->

            <input type="file" id='logoUploader' accept="image/*" onchange="printUploadedLogo()">
...
<script>
    function openbussinessConfiguration() {
        $('#bussinessConfiguration').addClass('active');
    }

    function closebussinessConfiguration() {
        $('#bussinessConfiguration').removeClass('active');
    }
</script>
