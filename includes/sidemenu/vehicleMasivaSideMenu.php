<div id="masivaVehicleSideMenu" class="sideMenu-s-full-screen">
    <button id="closeMasivaVehicle" style="border: none;background-color: none;padding: 30px;">
    ...
    <div style="display: flex;justify-content: space-between;">
        <div class="formHeader" style="align-items: center;align-content:center;margin-left: 14px;">
            ...
            <p class="header-P" style="line-height: 20px;letter-spacing: 0px;">Aquí puedes cargar un archivo Excel y agregar tus vehículos de forma masiva</p>
        </div>

        <button class="s-Button-w" id="" style="width: 150px;margin-right: 16px;">
            <p class="s-P-g" style="line-height: normal;"><a href="../../ExcelFiles/Vehiculos carga masiva excel tipo.xlsx" download="">Descargar Excel</a></p>
        </button>
    </div>
