<div id="masivaClienteSideMenu" class="sideMenu-s-full-screen">
    <button id="closeMasivaClientes" style="border: none;background-color: none;padding: 30px;">
    ...
    <div class="formHeader" style="align-items: center;align-content:center;margin-left: 14px;">
        ...
        <p class="header-P">Aquí puedes cargar un archivo Excel y agregar tus clientes de forma masiva</p>
    </div>
